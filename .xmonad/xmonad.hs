...
myKeys conf@XConfig {XMonad.modMask = modm} = M.fromList $
    ...
    , ((0,                  xF86XK_AudioRaiseVolume ), spawn "pulseaudio-control --volume-max 110 up"    ) -- Increment volume
    , ((0,                  xF86XK_AudioLowerVolume ), spawn "pulseaudio-control --volume-max 110 down"  ) -- Deincrement volume
    , ((0,                  xF86XK_AudioMute        ), spawn "pulseaudio-control togmute"                ) -- Mute
